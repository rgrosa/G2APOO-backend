...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> PasswordException(final PasswordException ex, final WebRequest request) {
		final ResponseResource responseResource = new ResponseResource(401, ex.getMessage(),null);
		return new ResponseEntity<>(responseResource, HttpStatus.UNAUTHORIZED);
	}
